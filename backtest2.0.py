...
sns.lineplot(y2020)
sns.lineplot(y2020.loc[y2020.index.month==3])
plt.show()

best_re = max_date(bond_prices_reinvested)
worst_re = min_date(bond_prices_reinvested)
y2020_re = bond_prices_reinvested[bond_prices_reinvested.index.year==2020]
sns.lineplot(y2020_re)
sns.lineplot(y2020_re.loc[y2020_re.index.month==3])
plt.tick_label_format(style='plain')
plt.show()

sns.lineplot(bond_prices)
sns.lineplot(y2020.loc[y2020.index.month==3])
plt.show()
